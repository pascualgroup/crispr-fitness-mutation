...
def speciesMullerPlotBoth(run_id, DBSIM_PATH, DBTREE_PATH, maxticksize, abundthreshold):
    fig = plt.figure()
...
def speciesMullerPlotBoth2(run_id, DBSIM_PATH, DBTREE_PATH, maxticksize, abundthreshold, spacingM, spacingV):
    fig = plt.figure()
    gs = fig.add_gridspec(7, 1, hspace=0, wspace=.15,
                        height_ratios=[1, 0.1, 1, 0.3, 3, .1, 3])
    ax1, ax6, ax2, ax3, ax4, ax7, ax5 = gs.subplots(sharex='col')
