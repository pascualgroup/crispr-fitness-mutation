...
#
## This includes Simpson Diversity
rateName = 'Competitive Advantage'
propTitle = 'Host Fitness Clade'
fig = plt.figure()
...
s = ['Expected {0} Mean'.format(rateName), r'$\mathbb{E}[\bar{f}]$']
axes[5].set_ylabel(
...
s = ['Expected {} SD '.format(rateName), r'$\mathbb{E}[\sigma_f]$']
...
axes[4].legend(loc='upper left', fontsize=10, title=propTitle, title_fontsize=10)
plt.show()
####
####
####
## 5 cells, shannon diversity
rateName = 'Competitive Advantage'
propTitle = 'Host Fitness Clade'
fig = plt.figure()
gs = plt.GridSpec(4, 2, figure=fig, hspace=.065, wspace=.6)
