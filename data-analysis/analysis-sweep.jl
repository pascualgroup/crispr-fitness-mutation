...
ROOT_PATH = joinpath("/scratch/cgsb/pascual/armun/crispr/vary-fitness/24_MOI3/data-analysis")
# dbSimPath = joinpath(SCRIPT_PATH, "..", "simulation", "sweep_db.sqlite")
dbSimPath = joinpath("/Volumes/Yadgah/sylvain-martin-collab/24_MOI3/sweep_db_gathered.sqlite")
